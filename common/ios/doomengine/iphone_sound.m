...
void Sound_Init( void ) {
    ...
    [[IDAudioSessionInterraptionListener sharedListener]
     addAudioSessionInterraptionHandler:^(AVAudioSessionInterruptionType interruptionType) {
         ...
         if ( interruptionType == AVAudioSessionInterruptionTypeBegan ) {
             ...
             if ( NO == [[AVAudioSession sharedInstance] setActive:YES error:&error] ) {
                 printf( "AudioSessionSetActive( true ) failed: domain = %s, code = %lu\n",
    ...
    otherAudioIsPlaying = [AVAudioSession sharedInstance].otherAudioPlaying;
